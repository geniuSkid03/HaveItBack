...
public class PermissionsHelper {
    ...
    private boolean shouldShowRationalDialog(String[] permissions) {
    ...
    public void askAndOpenSettings(String toShowMsg, final String cancelMsg) {
        if (getContext() == null) {
            return;
        }
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(PermissionsHelper.this.getContext(), "Grant permissions in settings", Toast.LENGTH_LONG).show();
                PermissionsHelper.this.getContext().startActivity(new Intent()
                        .setAction(Settings.ACTION_APPLICATION_DETAILS_SETTINGS)
                        .addCategory(Intent.CATEGORY_DEFAULT)
                        .setData(Uri.parse("package:" + PermissionsHelper.this.getContext().getPackageName()))
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(PermissionsHelper.this.getContext(), cancelMsg, Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean isCameraAndStoragePermissionsAvailable() {
        return checkPermission(new String[]{Permissions.READ_STORAGE})
                && checkPermission(new String[]{Permissions.WRITE_STORAGE})
                && checkPermission(new String[]{Permissions.CAMERA});
    }

    public void initContactsPermissions() {
        initPermissions(new String[]{Permissions.READ_CONTACTS});
    }

    public void initCameraAndStoragePermissions() {
        initPermissions(new String[]{Permissions.READ_STORAGE, Permissions.WRITE_STORAGE, Permissions.CAMERA});
    }
}
